const { isAnagram1, isAnagram2, isAnagram3, isAnagram4 } = require("./anagram");
...
test("anagram functions exist", () => {
  ...
  expect(typeof isAnagram4).toEqual("function");
});
...
test("'listen' is an anagram of 'silent'", () => {
  ...
  expect(isAnagram4("listen", "silent")).toBeTruthy();
});
...
test("'great' is not an anagram of 'egret'", () => {
  ...
  expect(isAnagram4("great", "egret")).toBeFalsy();
});
...
test("'awesome' is not an anagram of 'awesomes'", () => {
  ...
  expect(isAnagram4("awesome", "awesomes")).toBeFalsy();
});
...
test("'iceman0901' is an anagram of '67934Cinema'", () => {
  ...
  expect(isAnagram4("iceman0901", "1900Cinema")).toBeTruthy();
});
